...
def trainingApi(excel_dataset='./dataset/final_script.csv', per_device_train_batch_size=16, learning_rate=1e-5, warmup_steps=500, max_steps=4000, per_device_eval_batch_size=8, generation_max_length=225, save_steps=1000, eval_steps=1000, logging_steps=25, txtfile='txtfile', **kwargs):
...
# def trainingApi(excel_dataset='./manh_data/vi.csv', per_device_train_batch_size=16, learning_rate=1e-5, warmup_steps=500, max_steps=4000, per_device_eval_batch_size=8, generation_max_length=225, save_steps=1000, eval_steps=1000, logging_steps=25, txtfile='txtfile', **kwargs):
    ...
    trainer.train()
    best_model = f'best_{str(time.time())}'
